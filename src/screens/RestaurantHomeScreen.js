            ...
            <ScrollView>
                <View>
                     ...
                     <View style ={styles.view1}>
                        <Text style ={styles.text1}>GET {restaurantsData[id].discount}% OFF ON SERVICES TOTAL</Text>
                     </View>
                     }
                <View style ={styles.view2}>
                    <View style ={styles.view3}>
                        <Text style ={styles.text2}>{restaurantsData[id].carWashName}</Text>
                        ...
                        <View style ={styles.view4}>
                            ...
                            <Text style ={styles.text6}>{restaurantsData[id].farAway} ml away</Text> 
                        </View>
                    </View>
                    <View style ={styles.view5}>
                       <Text style = {styles.text6}>Done In</Text>
