...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, FlatList, Pressable, Image ,
 ...
 <ScrollView
      ...
      >
        ...
        <View style={{marginTop:10, flexDirection:"row", justifyContent:"space-evenly"}}>
            ...
            >
                ...
                <View style= {{...styles.servicesButton,backgroundColor: services?colors.buttons: colors.grey5}}>
        ...
        <View style= {{...styles.servicesButton,backgroundColor: services?colors.grey5: colors.buttons}}>
    <Text style= {styles.servicesText}>Location</Text>
        ...
        <View style={styles.addressView}>
            <View style= {{flexDirection:"row", alignItems:"center", paddingLeft:10}}>
                ...
                />
                <Text style={{marginLeft:5}}>Talisay City</Text>
        </View>
        ...
        <View style= {styles.headerTextView}>
            <Text style={styles.headerText}>Car wash now</Text>
        </View>
  ...
  renderItem={({ item }) => (
    <View style={{ marginRight: 5 }}>
      <FoodCard 
        screenWidth={SCREEN_WIDTH * 0.8}
        images={item.images} // Assuming item.images contains the image sources
        carWashName={item.carWashName}
        farAway={item.farAway}
        businessAddress={item.businessAddress}
        averageReview={item.averageReview}
