             ...
             <View style ={styles.container}>
                ...
                <View style = {{flexDirection:'row', alignItems:'center',
                    ...
                    <View style ={{marginLeft:10}}>
                        <Text style ={{fontWeight:'bold',color:colors.cardbackground,fontSize:18 }} >Jay Darwin</Text>
                        <Text style ={{color:colors.cardbackground,fontSize:14}} > Jay@Carwash.com</Text>
                    </View>
