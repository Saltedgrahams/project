...
export default function FoodCard({
  ...
  const isRemoteURL = typeof images === 'string' && images.startsWith('http');
  const imageSource = isRemoteURL ? { uri: images } : images;
        ...
        <View>
          ...
          <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            <View style={styles.distance}>
              ...
              />
              <Text style={styles.Min}> {farAway} : Bays Available</Text>
            </View>
